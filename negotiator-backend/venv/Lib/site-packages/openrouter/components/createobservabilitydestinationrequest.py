...
class CreateObservabilityDestinationRequestTypedDict(TypedDict):
    ...
    regions: NotRequired[List[ObservabilityDataRegionInput]]
    r"""Data regions this destination applies to. `eu` is accepted as an alias for `europe` and normalizes to `europe`. Omitting this field defaults to ['global']; the array must be non-empty."""
...
class CreateObservabilityDestinationRequest(BaseModel):
    ...
    regions: Optional[List[ObservabilityDataRegionInput]] = None
    r"""Data regions this destination applies to. `eu` is accepted as an alias for `europe` and normalizes to `europe`. Omitting this field defaults to ['global']; the array must be non-empty."""
