...
class GetWorkspaceBudgetGlobalsTypedDict(TypedDict):
...
class GetWorkspaceBudgetGlobals(BaseModel):
...
class GetWorkspaceBudgetRequestTypedDict(TypedDict):
    workspace_ref: str
...
class GetWorkspaceBudgetRequest(BaseModel):
