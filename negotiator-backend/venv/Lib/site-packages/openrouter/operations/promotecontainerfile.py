...
class PromoteContainerFileGlobalsTypedDict(TypedDict):
...
class PromoteContainerFileGlobals(BaseModel):
...
class PromoteContainerFileRequestTypedDict(TypedDict):
    container_id: str
...
class PromoteContainerFileRequest(BaseModel):
