...
class RegisterRequest(BaseModel):
    ...
    consent_given: bool = Field(
        ...,
        description="User consents to personal data processing. Must be true.",
        examples=[True],
    )
...
class AdminRegisterRequest(BaseModel):
    ...
    consent_given: bool = Field(
        ...,
        description="Consent to personal data processing. Must be true.",
        examples=[True],
    )
    registration_code: Optional[str] = Field(
        None,
        description="Required only if ADMIN_REGISTRATION_CODE is set in .env.",
    )
