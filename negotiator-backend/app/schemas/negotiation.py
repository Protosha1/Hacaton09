...
class StartNegotiationRequest(BaseModel):
    scenario_id: str = Field(..., min_length=1, max_length=100, examples=["scenario-1"])
...
class MessageRequest(BaseModel):
    session_id: str = Field(..., min_length=1, max_length=100, examples=["5b7ba051-189b-4fe3-9f82-aebc28feedf1"])
    message: str = Field(..., min_length=1, max_length=4000, examples=["Our price is $1200 per unit."])
